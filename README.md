...
* [Tai](https://github.com/fremantle-capital/tai) - Free and open source composable, real time, market data and trade execution toolkit. Built with Elixir, runs on the Erlang virtual machine.
